...
import us.luckylu.dev.client.config.TransportClientConfig;
...
public class EsServiceImpl implements EsService {
    ...
    public void search()throws Exception{
        ...
        SearchResponse sr=srb.setQuery(QueryBuilders.matchQuery("title", "最狼").analyzer(config.getAnalyzer()))
